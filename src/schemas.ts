...
const RelationshipField = z.object({
  data: z.array(z.object({ id: z.coerce.number(), type: z.string() })).optional(),
}).passthrough();
...
export const EventSchema = z.object({
  ...
  const group_ids = val.data.attributes.group_ids
  ...
  const { group_ids: _discardAttrGroupIds, ...restAttrs } = val.data.attributes;
  return {
    id: val.data.id,
    ...restAttrs,
    dates,
...
export const EventKindCategorySchema = z.object({
  data: z.object({
    id: z.coerce.number(),
...
export const EventsResponseSchema = z.object({
  ...
  const group_ids = item.attributes.group_ids
  ...
  const { group_ids: _discardAttrGroupIds, ...restAttrs } = item.attributes;
  return {
    id: item.id,
    ...restAttrs,
    dates,
...
export const MailingListsResponseSchema = z.object({
  data: z.array(z.object({
    id: z.coerce.number(),
    type: z.literal("mailing_lists"),
    attributes: MailingListAttributesSchema,
...
export const EventKindsResponseSchema = z.object({
  data: z.array(z.object({
    id: z.coerce.number(),
    type: z.literal("event_kinds"),
    attributes: EventKindAttributesSchema,
...
export const EventKindCategoriesResponseSchema = z.object({
  data: z.array(z.object({
    id: z.coerce.number(),
    type: z.literal("event_kind_categories"),
    attributes: EventKindCategoryAttributesSchema,
